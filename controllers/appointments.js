...
exports.updateAppointment = async (req,res,next) => {
    try{
        ...
        console.log(error);
        return res.status(500).json({success:false,message:"Cannot update the Appointment"});
    }
}
...
exports.getAppointment = async(req,res,next) => {
    try{
        ...
        console.log(error);
        return res.status(500).json({success:false,message:"Cannot fins Appointment"});
    }
}
